...
from app.api.v1 import (
    auth, buses, routes, stops, timetable, reports, favorites, notifications, ads, admin, analytics, extracted_timetable
)
...
api_router.include_router(extracted_timetable.router, prefix="/extracted-timetable", tags=["Extracted Timetable Ingestion"])
